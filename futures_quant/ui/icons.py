...
_ICONS: Dict[str, Tuple[str, str]] = {
    ...
    # AI 设置（齿轮 + 芯片）
    "settings": ("stroke",
        "M12 15 a3 3 0 1 0 0.01 0 M19.07 4.93 "
        "l-1.77 1.77 a7.04 7.04 0 0 0 0 4.6 l1.93 1.93 "
        "a7 7 0 0 0 0-8.3 z M4.93 19.07 l1.77-1.77 "
        "a7.04 7.04 0 0 0 0-4.6 l-1.93-1.93 "
